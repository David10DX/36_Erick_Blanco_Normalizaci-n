...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 18:01:37
...
--
-- Base de datos: `db_restaurantess`
--
...
(1, 'Pollo Norteño', '2021-05-25', 4),
(2, 'Masa para Pizza', '2021-05-19', 2);
...
(1, 'falkfjgjr', '2021-05-18', 2),
(2, 'jgdsbsas', '2021-05-09', 4),
(3, 'snfndmddassd', '2021-05-16', 4),
(4, 'fnns', '2021-05-25', 2);
...
(1, 'Pollo Frito con papas', 130, 1),
(2, 'Pizza de Peperoni Grande ', 230, 3),
(3, 'hamburguesa tres carnes', 210, 3);
...
(1, 'Pollo Frito con papas y un refresco', '2021-05-18', 1),
(2, 'Pizza de Pepperoni Grande', '2021-05-16', 3),
(3, 'Hamburguesa tres carnes y un refresco', '2021-05-25', 3);
...
ALTER TABLE `tbl_inventario`
  ...
  ADD KEY `FK_DIRECCCIONES_INVENTARIO` (`ID_DIRECCION`);
